...
from .video_tasks import create_video_template, generate_video_from_text
...
def generate_content_async(
    prompt, user_id=None, max_tokens=1000, model="claude-3-haiku-20240307"
):
    """
    ...
    try:
        ...
        logger.info(
            f"Content generation completed. Generated {len(generated_content)} characters."
        )
